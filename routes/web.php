...
Route::get('/', 'TvDashboard@index')->name('home');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('agenda/table', 'AgendaController@table')->name('admin.agenda.table');
    Route::get('agenda/add', 'AgendaController@add')->name('admin.agenda.add');
    Route::post('agenda/store', 'AgendaController@store')->name('admin.agenda.store');
    Route::post('agenda/update', 'AgendaController@update')->name('admin.agenda.update');
    Route::get('agenda/edit/{id}', 'AgendaController@edit')->name('admin.agenda.edit');
    Route::get('agenda/delete/{id}', 'AgendaController@delete')->name('admin.agenda.delete');
    Route::get('agenda/getDatatable', 'AgendaController@getDatatable')->name('admin.agenda.getDatatable');
});
